...
[一、HBase过滤器简介](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#一HBase过滤器简介)
[二、过滤器基础](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#二过滤器基础)
    [2.1 Filter接口和FilterBase抽象类](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#21--Filter接口和FilterBase抽象类)
    [2.2 过滤器分类](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#22-过滤器分类)
[三、比较过滤器](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#三比较过滤器)
    [3.1 比较运算符](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#31-比较运算符)
    [3.2 比较器](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#32-比较器)
    [3.3 比较过滤器种类](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#33-比较过滤器种类)
    [3.4 DependentColumnFilter](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#34-DependentColumnFilter)
[四、专用过滤器](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#四专用过滤器)
    [4.1 单列列值过滤器 (SingleColumnValueFilter)](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#41-单列列值过滤器-SingleColumnValueFilter)
    [4.2 单列列值排除器 (SingleColumnValueExcludeFilter)](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#42-单列列值排除器-SingleColumnValueExcludeFilter)
    [4.3 行键前缀过滤器 (PrefixFilter)](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#43-行键前缀过滤器-PrefixFilter)
    [4.4 列名前缀过滤器 (ColumnPrefixFilter)](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#44-列名前缀过滤器-ColumnPrefixFilter)
    [4.5 分页过滤器 (PageFilter)](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#45-分页过滤器-PageFilter)
    [4.6 时间戳过滤器 (TimestampsFilter)](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#46-时间戳过滤器-TimestampsFilter)
    [4.7 首次行键过滤器 (FirstKeyOnlyFilter)](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#47-首次行键过滤器-FirstKeyOnlyFilter)
[五、包装过滤器](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#五包装过滤器)
    [5.1 SkipFilter过滤器](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#51-SkipFilter过滤器)
    [5.2 WhileMatchFilter过滤器](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#52-WhileMatchFilter过滤器)
[六、FilterList](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Hbase过滤器详解.md#六FilterList)
...
[![img](https://github.com/heibaiying/BigData-Notes/raw/master/pictures/hbase-fliter.png)](https://github.com/heibaiying/BigData-Notes/blob/master/pictures/hbase-fliter.png)
...
[![img](https://github.com/heibaiying/BigData-Notes/raw/master/pictures/hbase-filterbase-subclass.png)](https://github.com/heibaiying/BigData-Notes/blob/master/pictures/hbase-filterbase-subclass.png)
...
[![img](https://github.com/heibaiying/BigData-Notes/raw/master/pictures/hbase-bytearraycomparable.png)](https://github.com/heibaiying/BigData-Notes/blob/master/pictures/hbase-bytearraycomparable.png)
...
[![img](https://github.com/heibaiying/BigData-Notes/raw/master/pictures/hbase-compareFilter.png)](https://github.com/heibaiying/BigData-Notes/blob/master/pictures/hbase-compareFilter.png)
