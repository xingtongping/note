...
![img](https://gitee.com/zyf542869246/BigData-Notes/raw/master/pictures/kafka-consumer01.png)

需要注意的是：同一个分区只能被同一个消费者群组里面的一个消费者读取，不可能存在同一个分区被同一个消费者群里多个消费者共同读取的情况，如图：

![img](https://gitee.com/zyf542869246/BigData-Notes/raw/master/pictures/kafka-consumer02.png)
